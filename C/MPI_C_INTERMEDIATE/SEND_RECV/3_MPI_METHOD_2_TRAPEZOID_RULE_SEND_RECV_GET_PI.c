...
$ mpicc 2_MPI_METHOD_2_TRAPEZOID_RULE_SEND_RECV_GET_PI.c -o out -lm
$ mpirun -np 4 ./out 1000000000
Done!! ... Now collecting output from others
Pi fraction received from proc 0  = 196349541.099370
Pi fraction received from proc 1  = 196349540.974348
Pi fraction received from proc 2  = 196349540.849357
Pi fraction received from proc 3  = 196349540.724355
Time = 3.368667s;    PI = 3.141593
PI is approximately 3.1415926545897168, Error is 0.0000000009999237
 */
#include <stdio.h>
#include <stdlib.h>
#include <sys/time.h>
